...
namespace redline_deobfuscator
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                if (args.Length < 1) { Console.WriteLine("Usage: redline-deobfuscator input.exe output.exe"); return; }
                if (args.Length < 2) { Console.WriteLine("Usage: redline-deobfuscator input.exe output.exe"); return; }
            ...
            catch (Exception e)
            {
                ...
                Console.WriteLine("[x] Exceptions ==> " + e.StackTrace);
